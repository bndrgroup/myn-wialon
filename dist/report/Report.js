...
class Report extends RemoteAPI_1.RemoteAPI {
    constructor() {
        ...
        this.getResultMap = (params) => __awaiter(this, void 0, void 0, function* () { return RemoteAPI_1.RemoteAPI.execute("report/select_result_rows", params, this.sessionId, this.options.host); });
